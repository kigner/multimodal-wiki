...
## 来源
[1] [[arc2face]] · `<WIKI_PATH>\raw\papers\Arc2Face A Foundation Model for ID-Consistent Human Faces [353538b9].md` · §Abstract

[2] [[arc2face]] · `<WIKI_PATH>\raw\papers\Arc2Face A Foundation Model for ID-Consistent Human Faces [353538b9].md` · §3.1 ("we meticulously upsample ... WebFace42M")
```
